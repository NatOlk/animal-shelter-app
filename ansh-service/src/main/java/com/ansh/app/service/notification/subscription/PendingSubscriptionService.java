...
public interface PendingSubscriptionService {
   ...
   */
  void approveSubscriber(String email, String approver);
   ...
   * @param approver the email or identifier of the approver
   */
  void rejectSubscriber(String email, String approver);

  /**
   * Retrieves a list of pending subscribers that require approval from a specific approver.
   *
   * @param approver the email or identifier of the approver
   * @return a list of {@link PendingSubscriber} objects awaiting approval from the specified
   * approver
   */
